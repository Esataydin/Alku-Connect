        ...
        {comments && <>
            <div className="d-flex mb-3">
              ...
              <form className="w-100 position-relative">
                <textarea data-autoresize className="form-control pe-4 bg-light" rows={1} placeholder="Add a commentt..." defaultValue={''} />
...
const Post3 = () => {
  return <Card>
      ...
      <CardBody>
        <p className="mb-0">
          The next-generation bloggg, news, and magazine theme for you to start sharing your content today with beautiful aesthetics! This minimal &amp;
